...
public class BodyEditorLoader {
  ...
  /**
   * Creates and applies the fixtures defined in the editor. The name parameter
   * is used to retrieve the right fixture from the loaded file. <br/>
   * <br/>
   *
   * The body reference point (the red cross in the tool) is by default located
   * at the bottom left corner of the image. This reference point will be put
   * right over the BodyDef position point. Therefore, you should place this
   * reference point carefully to let you place your body in your world easily
   * with its BodyDef.position point. Note that to draw an image at the position
   * of your body, you will need to know this reference point (see
   ...
   * factor so the polygons get resized according to your needs (not every body
   * is 1 meter large in your game, I guess).
   *
   * @param body
  ...
  /**
   * <b>For advanced users only.</b> Lets you access the internal model of this
   * loader and modify it. Be aware that any modification is permanent and that
